...
.demoMentorChats{margin-top:28px}.demoMentorChats .demoChat{margin-top:16px}.mentorDashboardChat{grid-template-columns:minmax(190px,240px) minmax(0,1fr);width:100%;max-width:none;align-items:stretch}.mentorDashboardChat>.demoThreads,.mentorDashboardChat>.demoChatPanel{width:100%;min-width:0;max-width:none}.mentorDashboardChat .demoMessages{width:100%;max-width:none}.mentorDashboardChat .demoMessageForm{display:grid;grid-template-columns:minmax(0,1fr) auto;width:100%}.mentorDashboardChat .demoMessageForm input{width:100%;min-width:0}.mentorshipTime{font-variant-numeric:tabular-nums;color:var(--muted)}
@media(max-width:900px){.demoAssistantLayout{grid-template-columns:1fr}.demoCalendarDay{min-height:105px;padding:6px}}
@media(max-width:820px){.mentorDashboardChat{grid-template-columns:1fr}}
...
function formatMentorshipDateTime(value: string) {
